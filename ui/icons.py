# -*- coding: utf-8 -*-
"""
差旅搭子 - 内嵌 SVG 线性图标集（无外部资源依赖）。
所有图标为 24x24 viewBox 的描边线性风格，支持按颜色渲染为 QIcon。
"""
...
_PATHS = {
    ...
    "tag": '<path d="M20.59 13.41 11 3.83A2 2 0 0 0 9.59 3H4a2 2 0 0 0-2 2v5.59A2 2 0 0 0 3.83 13l9.59 9.59a2 2 0 0 0 2.83 0l4.34-4.34a2 2 0 0 0 0-2.83z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',
}


def icon(name: str, color: str = "#475569", size: int = 22) -> QIcon:
    """渲染指定名称的 SVG 图标为 QIcon。color 为描边色。"""
...
def pixmap(name: str, color: str = "#475569", size: int = 22) -> QPixmap:
